    ...
    <div class="mt-6 flex flex-col gap-6 lg:flex-row">
      ...
      <div class="flex-1 space-y-4">
        ...
        <div class="flex gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <button class="shrink-0 self-start rounded-lg p-2 text-slate-400 hover:bg-rose-50 hover:text-rose-600 transition" aria-label="Remove">
        ...
        <div class="sticky top-24 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div class="mt-4">
            <div class="flex gap-2">
              <input type="text" placeholder="কুপন কোড" class="flex-1 rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20" />
